...
\begin{enumerate}
    ...
    \item \textbf{Empirical validation} through application to six waves of the Global Dialogues survey ($N \approx 1{,}000$ per wave), seven waves of the World Values Survey ($N = 9{,}000$--$85{,}000$ per wave), and regional surveys (Afrobarometer, Latinobar\'{o}metro), including Monte Carlo simulation of maximum achievable scores and efficiency analysis.
...
Table~\ref{tab:gri_scores} presents GRI scores for primary and selected auxiliary dimensions. Gender balance is essentially perfect (GRI $> 0.97$). Continental representativeness is good (GRI $\approx 0.83$). The picture deteriorates sharply at finer granularity: Country $\times$ Gender $\times$ Age averages only 0.34, indicating roughly 66\% of the joint demographic weight is misallocated.
...
\midrule
Country $\times$ Gender $\times$ Age & 0.337 & 0.329 & 0.348 & 0.361 & 0.347 & 0.341 & 0.344 & 0.03 \\
Country $\times$ Religion & 0.482 & 0.488 & 0.514 & 0.535 & 0.499 & 0.495 & 0.502 & 0.05 \\
Country $\times$ Environment & 0.424 & 0.394 & 0.435 & 0.453 & 0.414 & 0.406 & 0.421 & 0.06 \\
Country & 0.590 & 0.573 & 0.618 & 0.639 & 0.592 & 0.587 & 0.600 & 0.07 \\
...
Table~\ref{tab:efficiency} shows efficiency ratios---actual GRI divided by Monte Carlo maximum. The GD achieves approximately 43\% efficiency on Country $\times$ Gender $\times$ Age and 53.5\% on Country $\times$ Religion, indicating room for improvement through better sampling design. GD4 achieves the highest efficiency across all primary dimensions.
...
\midrule
C $\times$ G $\times$ A & 0.792 & 42.5\% & 41.6\% & 44.0\% & 45.5\% & 43.8\% & 43.0\% & 43.4\% \\
C $\times$ Religion & 0.938 & 51.4\% & 52.0\% & 54.8\% & 57.0\% & 53.2\% & 52.7\% & 53.5\% \\
C $\times$ Environ. & 0.950 & 44.7\% & 41.5\% & 45.7\% & 47.7\% & 43.6\% & 42.7\% & 44.3\% \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Sample size per wave & $\sim$1,083 & $\sim$57,600 \\
Countries per wave & $\sim$58 & $\sim$40 \\
CGA GRI & 0.344 & 0.195 \\
Country $\times$ Religion GRI & 0.502 & 0.301 \\
Country $\times$ Environment GRI & 0.421 & 0.320 \\
CGA $d_{\text{eff}}$ & 3.03 & 2.71 \\
